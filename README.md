...
$sudo apt install ros-humble-joint-state-publisher-gui$ sudo apt install ros-humble-rqt-image-view
# Crucial dependencies for Gazebo and control (ros2_control)
